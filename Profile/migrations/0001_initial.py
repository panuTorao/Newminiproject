    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='Profile.customers')),
            ],
        ),
        migrations.CreateModel(
            name='Products',
            fields=[
                ...
                ('category', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='Profile.categories')),
            ],
        ),
        migrations.CreateModel(
            name='Transfers',
            fields=[
                ...
                ('order', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='Profile.orders')),
            ],
        ),
        migrations.CreateModel(
            name='Send',
            fields=[
                ...
                ('comment', models.CharField(default='', max_length=200)),
                ('employee', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='Profile.employees')),
                ('order', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='Profile.orders')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='Profile.products')),
            ],
        ),
        migrations.CreateModel(
            name='Reject',
